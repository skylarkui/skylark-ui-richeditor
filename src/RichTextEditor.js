  ...
  "skylark-utils/widgets"  
],function(skylark,langx,browser,datax,eventer,noder,geom,velm,$,widgets){
    'use strict';
    var ui = skylark.ui = skylark.ui || {};

    var RichTextEditor = ui.RichTextEditor = widgets.Widget.inherit({
    ...
    $.fn.rteditor = function ( options ) {
        return this.each(function () {
            if (!datax.data(this, 'richTextEditor')) {
                datax.data(this, 'richTextEditor',
